...
@Repository
public class RailwayFormDAO extends BaseDAO<RailwayForm> {
	...
	protected String getInsertSql() {
		return "INSERT INTO "
				+ getTableName()
				+ "(username,firstname,lastname,dob,fromStation,toStation,address,year,date,sex,type,serviceId,level1,level2,level3,flag1,flag2,flag3,remark1,remark2,remark3,createdBy,createdDate,lastModifiedBy,lastModifiedDate,payment,isSubmitted,active)"

				+ " VALUES(:username,:firstname,:lastname,:dob,:fromStation,:toStation,:address,:year,:date,:sex,:type,:serviceId,:level1,:level2,:level3,:flag1,:flag2,:flag3,:remark1,:remark2,:remark3,:createdBy,:createdDate,:lastModifiedBy,:lastModifiedDate,:payment,:isSubmitted,:active)";
	}
	...
	protected String getUpdateSql() {
		final String sql = "Update " + getTableName() + " set "
				...
				+ "dob = :dob ," + "fromStation = :fromStation ,"
				+ "toStation = :toStation ," + "username = :username ,"
				+ "address = :address ," + "year = :year ," + "sex = :sex ,"
				+ "type = :type ," + "date = :date ,"
				+ "serviceId = :serviceId ," + "level1 = :level1 ,"
	...
	public void saveRCRemarks(String remarkValue, String remarkCol, Long pk) {
		RailwayForm RCForm = new RailwayForm();
	...
	public void saveRCStatusForLevel3(String flagValue, String flagCol,
			String pk) {
		RailwayForm rcForm = new RailwayForm();

		rcForm.setId(Long.valueOf(pk));
	...
	public void saveRCRemarksForLevel3(String remarkValue, String remarkCol,
			String pk) {
		RailwayForm rcForm = new RailwayForm();
		// bonafideForm.setRemark1(remarkValue);
		rcForm.setId(Long.valueOf(pk));
