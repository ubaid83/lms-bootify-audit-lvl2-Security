...
public class GorwableList<T> implements List<T> {
	 ...
	 */
	public GorwableList(List<T> otherList) {
	 ...
	 */
	public GorwableList(List<T> otherList, Boolean ignoreIndex) {
		super();
		this.otherList = otherList;
		this.ignoreIndex = ignoreIndex;
	}

	public GorwableList(List<T> otherList, Boolean ignoreIndex, CreateInstanceFactory<T> instanceFactory) {
		this(otherList, false);
