...
public class BonafideForm extends BaseBean implements Serializable{
	...
	public String toString() {
		return "BonafideForm [username=" + username + ", firstname="
				+ firstname + ", lastname=" + lastname + ", fatherName="
				+ fatherName + ", motherName=" + motherName + ", rollNo="
				+ rollNo + ", acadYear=" + acadYear + ", programName="
				+ programName + ", studyClass=" + studyClass + ", division="
				+ division + ", reason=" + reason + ", serviceId=" + serviceId
				...
				+ ", isSaveAsDraft=" + isSaveAsDraft + ", payment=" + payment
