...
@Controller
public class BlacBoardAssigmentWsController extends BaseController {
	...
	@RequestMapping(value = "/createAssignmentFromJson", method = {
	...
	@RequestMapping(value = "/allocateAssignmentToStudentsByParam", method = {
			RequestMethod.GET, RequestMethod.POST })
	public @ResponseBody Assignment allocateAssignmentToStudentsByParam(
		...
		try {
			...
			try {
				studLst = studentAssignmentService
						.findAssignmentSubmissionLst(username,
	...
	@RequestMapping(value = "/getCoursesForBB", method = { RequestMethod.GET,
			RequestMethod.POST })
	public @ResponseBody List<CourseDetail> getCoursesForBB(
			@RequestParam(name = "username", required = false) String username) {
		List<CourseDetail> courseList = new ArrayList();
	...
	private String uploadContentFile(Content bean, MultipartFile file) {
		...
		try {
			...
			String filePath = contentFolder + File.separator + fileName;

			

			File folderPath = new File(contentFolder);
	...
	@RequestMapping(value = "/createContentFromJSON", method = {

	RequestMethod.GET, RequestMethod.POST })
	public @ResponseBody Content createContentFromJSON(
		...
		content.setCreatedBy("CA");

		content.setLastModifiedBy("CA");
	...
	@RequestMapping(value = "/allocateContentToStudentsByParam", method = {
