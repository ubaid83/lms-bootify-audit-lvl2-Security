					...
					<div class="dashboard_height" id="main">
						...
						<div class="dashboard_contain_specing dash-main">
							...
							<div class="alert alert-success alert-dismissible" role="alert">
								...
								<h4>
									<strong>Welcome to LOR STAFF Login </strong>
								...
								<sec:authorize access="hasAnyRole('ROLE_STAFF')">
									...
									<div class="col-md-4 course_widget_height">
										<div class="dashboardcon_title bgcolor2">
											<div>
												<c:url value="viewAppliedApplicationStudentsForDepartment" var="viewStudent">
													<c:param name="" value="" />
												</c:url>
											</div>
											<span><a href="${viewStudent}">View Student</a></span>
										</div>
									</div>
