														...
														<tbody>
															...
															<c:forEach var="service" items="${serviceList}"
																...
																<tr>
																	...
																	<c:url value="viewBonafideServiceForStaff"
																				var="detailsUrl">
																	...
																	<c:url value="viewRCServiceForStaff"
																				var="detailsUrl">
																				<c:param name="serviceId" value="${service.id}" />
																			</c:url>
																	
																	</c:if>
																	<c:if test="${service.name eq 'Hostel Service'}">
																	...
																	<sec:authorize
																			...
																			<c:if test="${service.bonafide eq null }">
																			...
																			<c:if test="${service.bonafide ne null }">
																				<c:if
																					test="${service.bonafide.flag2 eq 'APPROVED' || service.bonafide.flag2 eq 'REJECTED' }">
																	...
																	<c:if test="${service.bonafide ne null }">
																	<c:out value="${service.bonafide.id}" /></c:if>
																	
																	</td>
																		<td><c:if test="${service.bonafide ne null }">
																				<c:if test="${service.bonafide.flag1 eq 'PENDING'}">
																				...
																				<c:if test="${service.bonafide.flag1 eq 'REJECTED'}">
																				...
																				<c:if test="${service.bonafide.flag1 eq 'APPROVED'}">
																					...
																					<c:if test="${service.bonafide.flag2 eq 'PENDING'}">
																						<label class="amber"> <input type="radio"
																							name="color" value="amber">

																							<div class="button">
																								<span
																									title="Pending By ${service.bonafide.user2}"></span>
																							</div>
																						</label>
																					...
																					<c:if
																						test="${service.bonafide.flag2 eq 'REJECTED'}">
																						<label class="orange"> <input type="radio"
																							name="color" value="orange">

																							<div class="button">
																								<span
																									title="Rejected By ${service.bonafide.user2}"></span>
																							</div>
																						</label>
																						<label class="nocolor"> <input
																							type="radio" name="color" value="nocolor">
																					...
																					<c:if
																						test="${service.bonafide.flag2 eq 'APPROVED'}">
																						<label class="lime"> <input type="radio"
																							name="color" value="lime">

																							<div class="button">
																								<span
																									title="Approved By ${service.bonafide.user2}"></span>
																							</div>
																						</label>
																						<label class="lime"> <input type="radio"
																							name="color" value="lime">
																			...
																			</c:if> <c:if test="${service.bonafide eq null }">
																			 Not Submitted
																			</c:if></td>
																	...
																	<sec:authorize access="hasAnyRole('ROLE_STUDENT')">
																		<td><c:if
																				test="${service.bonafide.flag1 eq 'APPROVED' && service.bonafide.flag2 eq 'PENDING' || service.bonafide.flag1 eq 'REJECTED'}">
																				<c:out value="${service.bonafide.remark1}" />
																			</c:if> <c:if
																				test="${service.bonafide.flag2 eq 'APPROVED' || service.bonafide.flag2 eq 'REJECTED'}">
																				<c:out value="${service.bonafide.remark2}" />
																			</c:if></td>
