								...
								<form:form action="" method="post"
									...
									<div class="row">
										<div class="col-xs-12 col-sm-12">
											<div class="x_panel">
												<div class="x_title">
													<h2>Students | ${fn:length(rList)} Records Found |
												...
												<div class="x_content">
													...
													<a
														href="downloadStudentsHostelForms?serviceId=${serviceId }&levelNum=${levelNum}"><i
															...
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<button id="submit" type="submit"
																		formaction="uploadStudentsHostelForms"
													...
													<div class="table-responsive">
														<table class="table table-hover" id="POITable">
															...
															<tbody>
																...
																<c:forEach var="student" items="${rList}"
																	varStatus="status">
																	<tr id="tr${student.id}">
																		...
																		<td><c:url value="viewStudentHostelApplication"
																				var="viewStudentHostelApplicationurl">
																				<c:param name="id" value="${student.id }"></c:param>


																			</c:url> <a href="${viewStudentHostelApplicationurl}"
																			title="View Application"><i
																				class="fa fa-info-circle fa-lg"></i></a>&nbsp; <a
																			href="${viewStudentHostelApplicationurl}"
																		...
																		<td><c:if
																				...
																				<c:if test="${student.allowLevel2 eq true}">
																					<a href="#" class="editable" id="radio2"
																						data-type="select" data-pk="${student.id}"
																						data-source="[{value: 'APPROVED', text: 'Approve'},{value: 'REJECTED', text: 'Reject'}]"
																						data-url="saveRCStatus?flag=flag2"
																				...
																				<c:if test="${student.allowLevel3 eq true}">
																					<a href="#" class="editable" id="radio3"
																						data-type="select" data-pk="${student.id}"
																						data-source="[{value: 'APPROVED', text: 'Approve'},{value: 'REJECTED', text: 'Reject'}]"
																						data-url="saveRCStatus?flag=flag3"
																		...
																		<td><c:if test="${showRemark}">
																				<a href="#" class="editable" id="remark1"
																					...
																					data-url="saveRCRemarks?remark=remark1"
																			...
																			<form:input path="remark1" value=""/>
																				...
																				<a href="#" class="editable" id="remark2"
																					data-type="textarea" data-pk="${student.id}"
																					data-url="saveRCRemarks?remark=remark2 "
																				...
																				<a href="#" class="editable" id="remark3"
																					data-type="textarea" data-pk="${student.id}"
																					data-url="saveRCRemarks?remark=remark3 "
