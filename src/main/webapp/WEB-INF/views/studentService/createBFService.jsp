								...
								<div class="x_panel">
									...
									<div class="x_content">
										<form:form action="updateBFService" method="post"
											...
											<div class="row">
												<div class="col-sm-6 col-md-4 col-xs-12 column">
													<div class="form-group">
														...
														<c:if test="${studentServiceBean.payment eq 'N' }">
														Free
														</c:if>
												...
												<div class="table-responsive" style="display: inline-block;">
													<table class="table  table-hover">
														...
														<tbody>
															...
															<c:if
																test="${studentServiceBean.name ne 'Hostel Service' }">
																<tr>
											...
											<c:if test="${studentServiceBean.name eq 'Hostel Service' }">
												<div class="row">
													...
													<div class="col-md-4 col-sm-6 col-xs-12 column"
														...
														<div class="form-group">
															...
															<form:input path="totalSeats" class="form-control"
																value="${studentServiceBean.totalSeats}" type="number"
																required="required" />
														</div>
													</div>
											...
											<c:if test="${studentServiceBean.name ne 'Hostel Service' }">
												<div class="row">
													<div class="col-md-4 col-sm-6 col-xs-12 column"
														style="width: fit-content">
														<div class="form-group">
												...
												<div class="col-sm-12 column">
													<div class="form-group">
														<button id="submit" class="btn btn-large btn-primary"
															formaction="updateBFService">Update Service</button>
