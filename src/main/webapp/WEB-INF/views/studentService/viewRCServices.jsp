															...
															<c:forEach var="service" items="${serviceList}"
																...
																<tr>
																	...
																	<td><sec:authorize
																			...
																			<c:if test="${service.railway eq null }">
																			...
																			<c:if test="${service.railway ne null }">
																				<c:if
																					test="${service.railway.flag2 eq 'APPROVED' || service.railway.flag2 eq 'REJECTED' }">
																	...
																	<c:if test="${service.railway ne null }">
																	<c:out value="${service.railway.id}" /></c:if>
																	
																	</td>
																		<td><c:if test="${service.railway ne null }">
																				<c:if test="${service.railway.flag1 eq 'PENDING'}">
																				...
																				<c:if test="${service.railway.flag1 eq 'REJECTED'}">
																				...
																				<c:if test="${service.railway.flag1 eq 'APPROVED'}">
																					...
																					<c:if test="${service.railway.flag2 eq 'PENDING'}">
																						<label class="amber"> <input type="radio"
																							name="color" value="amber">

																							<div class="button">
																								<span
																									title="Pending By ${service.railway.user2}"></span>
																							</div>
																						</label>
																					...
																					<c:if
																						test="${service.railway.flag2 eq 'REJECTED'}">
																						<label class="orange"> <input type="radio"
																							name="color" value="orange">

																							<div class="button">
																								<span
																									title="Rejected By ${service.railway.user2}"></span>
																							</div>
																						</label>
																						<label class="nocolor"> <input
																							type="radio" name="color" value="nocolor">
																					...
																					<c:if
																						test="${service.railway.flag2 eq 'APPROVED'}">
																						<label class="lime"> <input type="radio"
																							name="color" value="lime">

																							<div class="button">
																								<span
																									title="Approved By ${service.railway.user2}"></span>
																							</div>
																						</label>
																						<label class="lime"> <input type="radio"
																							name="color" value="lime">
																			...
																			</c:if> <c:if test="${service.railway eq null }">
																			 Not Submitted
																			</c:if></td>
																	...
																	<sec:authorize access="hasAnyRole('ROLE_STUDENT')">
																		<td><c:if
																				test="${service.railway.flag1 eq 'APPROVED' && service.railway.flag2 eq 'PENDING' || service.railway.flag1 eq 'REJECTED'}">
																				<c:out value="${service.railway.remark1}" />
																			</c:if> <c:if
																				test="${service.railway.flag2 eq 'APPROVED' || service.railway.flag2 eq 'REJECTED'}">
																				<c:out value="${service.railway.remark2}" />
																			</c:if></td>
