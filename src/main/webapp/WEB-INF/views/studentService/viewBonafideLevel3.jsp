									...
									<div class="row">
										<div class="col-xs-12 col-sm-12">
											<div class="x_panel">
												...
												<div class="x_content">
													<a
														href="downloadStudentsBonafideFormsForLevel3?serviceId=${serviceId }"><i
															...
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<button id="submit" type="submit"
																		formaction="uploadStudentsBonafideFormsForLevel3"
																	...
																	<tr id="tr${student.id}">
																		...
																		<td><c:if
																				...
																				<c:if test="${showActions}">
																					<a href="#" class="editable" id="radio1"
																						...
																						data-url="saveBonafideStatusForLevel3?flag=flag2"
																		...
																		<td><c:if test="${showRemark}">
																				<a href="#" class="editable" id="remark1"
																					...
																					data-url="saveBonafideRemarksForLevel3?remark=remark2"
