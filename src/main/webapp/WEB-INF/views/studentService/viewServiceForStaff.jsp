				...
				<div class="dashboard_container">
					...
					<div class="dashboard_container_spacing">
						...
						<div class="breadcrumb">
							...
							<i class="fa fa-angle-right"></i> Submitted Students List
						</div>
								...
								<form:form action="" method="post"
									...
									<div class="row">
										<div class="col-xs-12 col-sm-12">
											<div class="x_panel">
												<div class="x_title">
													<h2>Students | ${fn:length(bList)} Records Found |
												...
												<div class="x_content">
													...
													<a
														href="downloadStudentsBonafideForms?serviceId=${serviceId }&levelNum=${levelNum}"><i
														class="btn btn-large btn-primary">Download All Pending
															Applications</i></a>
															...
															<div class="modal-content">
																...
																<div class="modal-footer">
																	...
																	<button id="submit" type="submit"
																		formaction="uploadStudentsBonafideForms"
													...
													<div class="table-responsive">
														<table class="table table-hover" id="POITable">
															...
															<tbody>
																...
																<c:forEach var="student" items="${bList}"
																	varStatus="status">
																	<tr id="tr${student.id}">
																		...
																		<td><c:url value="viewStudentBonafideApplication"
																				var="viewStudentBonafideApplicationurl">
																				<c:param name="id" value="${student.id }"></c:param>


																			</c:url> <a href="${viewStudentBonafideApplicationurl}"
																			title="View Application"><i
																				class="fa fa-info-circle fa-lg"></i></a>&nbsp; <a
																			href="${viewStudentBonafideApplicationurl}"
																			id="target2" data-toggle="modal"
																			data-target="#myModal2" title="View Progress"><i
																				class="icon-progress"></i></a></td>
																		...
																		<td><c:if
																				...
																				<%-- <c:if test="${showActions}">
																					<a href="#" class="editable" id="radio1"
																						...
																						data-url="saveBonafideStatus?flag=flag1"
																						data-title="Select Status">${student.flag1}</a>
																				...
																				<c:if test="${student.allowLevel2 eq true}">
																					<a href="#" class="editable" id="radio2"
																						data-type="select" data-pk="${student.id}"
																						data-source="[{value: 'APPROVED', text: 'Approve'},{value: 'REJECTED', text: 'Reject'}]"
																						data-url="saveBonafideStatus?flag=flag2"
																						data-title="Select Status">${student.flag2}</a>
																					<%-- <form:radiobutton path = "flag2" value = "A" label = "Approve" />
                  																<form:radiobutton path = "flag2" value = "R" label = "Reject" /> --%>
																					<%-- <a
																						href="approveBonafideApplication?id=${student.id}&status=1"
																						id="like${student.id}"
																						class="btn btn-primary btn-xs likeClass">Approve</a>
																				...
																				<c:if test="${student.allowLevel3 eq true}">
																					<a href="#" class="editable" id="radio3"
																						data-type="select" data-pk="${student.id}"
																						data-source="[{value: 'APPROVED', text: 'Approve'},{value: 'REJECTED', text: 'Reject'}]"
																						data-url="saveBonafideStatus?flag=flag3"
																						data-title="Select Status">${student.flag3}</a>
																					<%-- <form:radiobutton path = "flag3" value = "A" label = "Approve" />
                  																<form:radiobutton path = "flag3" value = "R" label = "Reject" /> --%>
																					<%-- <a
																						href="approveBonafideApplication?id=${student.id}&status=1"
																						id="like${student.id}"
																						class="btn btn-primary btn-xs likeClass">Approve</a>
																		...
																		<td><c:if test="${showRemark}">
																				<a href="#" class="editable" id="remark1"
																					...
																					data-url="saveBonafideRemarks?remark=remark1"
																					data-title="Enter Remarks">${student.remark1}</a>

																				<%-- <form:input path="remark1" value="" placeholder="remark1"/> --%>
																			</c:if> <%-- <c:if test="${student.remark1 eq null}">
																			<form:input path="remark1" value=""/>
																			</c:if> --%> <c:if
																				test="${student.allowRemark2 eq true}">
																				<a href="#" class="editable" id="remark2"
																					data-type="textarea" data-pk="${student.id}"
																					data-url="saveBonafideRemarks?remark=remark2 "
																					data-title="Enter Remarks">${student.remark2}</a>
																				<%-- <form:input path="remark2" value="" placeholder="remark2"/> --%>
																			</c:if> <c:if test="${student.allowRemark3 eq true}">
																				<a href="#" class="editable" id="remark3"
																					data-type="textarea" data-pk="${student.id}"
																					data-url="saveBonafideRemarks?remark=remark3 "
																					data-title="Enter Remarks">${student.remark3}</a>
																				<%-- <form:input path="remark3" value="" placeholder="remark3"/> --%>
																			</c:if></td>
																	</tr>
																</c:forEach>
															</tbody>
