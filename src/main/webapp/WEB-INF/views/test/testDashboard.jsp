					...
					<div class="bg-white pb-5">
						<nav class="" aria-label="breadcrumb">
							<ol class="breadcrumb d-flex">
								...
								<li class="ml-auto">
									<select class="form-control" id="semSelectFaculty">
								...
								<c:forEach var='cList' items='${ sessionWiseCourseList[userBean.acadSession] }'>
									<div class="col-lg-3 col-md-3 col-sm-6 col-6 mt-5">
										<div class="courseAsset d-flex align-items-start flex-column">
											...
											<span class="courseNav"> <a href="${pageContext.request.contextPath}/createTestForm?courseId=${cList.id}">
													<p class="caBg">Create Test</p>
											</a> <a href="${pageContext.request.contextPath}/createTestForm?courseId=${cList.id}">
