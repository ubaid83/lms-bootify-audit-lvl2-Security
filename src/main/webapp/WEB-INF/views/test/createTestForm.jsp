...
<%
	List<DashBoard> courseDetailList = (List<DashBoard>) session.getAttribute("courseDetailList");
...
<div class="d-flex" id="facultyDashboardPage">
								...
								<div class="card-body">
									...
									<form:form action="addTest" method="post" modelAttribute="test">
										...
										<div class="form-row">
											...
											<div
												class="col-lg-4 col-md-4 col-sm-12 mt-3 position-relative">
												<label class="textStrong">Select Course <span
													class="text-danger">*</span></label>
												<form:select id="idOfCourse" path="idOfCourse"
											...
											<div
												class="col-lg-4 col-md-4 col-sm-12 mt-3 position-relative">
												<label class="textStrong">Faculty<span
													class="text-danger">*</span></label>
										...
										<div class="form-row">
											...
											<%
												if (!isEdit) {
											%>
											<c:if test="${allocateFaculty}">
											<div class="col-lg-6 col-md-6 col-sm-12 mt-3 mb-3">
												<label class="textStrong">Allow Co-Faculty to take a Demo test?</label>
												<div>
													<div class="pretty p-switch p-fill p-toggle">
														<form:checkbox id="isPeerFacultyForDemo" value="N" path="isPeerFacultyForDemo" />
														<div class="state p-success p-on">
															<label>Yes</label>
														</div>
														<div class="state p-danger p-off">
												...
												<div class="form-check pl-0 mt-2 d-none">
													<form:select id="peerFacultiesForDemo" path="peerFacultiesForDemo"
 ...
 %>
										...
										<div class="col-6 m-auto">
											<div class="form-row mt-5">
												...
												<button id="updateTestBtn"
													...
													formaction="updateTest">Update Test</button>
				...
				<script>
					...
					//For Mix Test
					$("#randQReq").change(function() {
						let isChecked = $(this).is(":checked");
						let testType = $("#testType").val().toLowerCase();

						if (isChecked === true && testType === "mix") {
							$("#smqChk").val("Y").prop("checked", true)
							$("#marksPerQueIn").parent().removeClass("d-none")
							
							
						} else {
							$("#smqChk").val("N").prop("checked", false)
							$("#marksPerQueIn").val(0).parent().addClass("d-none")
						}
					})
				</script>
				<script>
					...
					$(function() {
						...
						$('#createTestBtn')
                            ...
                            //console.log("smq-->"+smq);
                            var maxQ1 = $("#maxQuestnToShow1").val();
                            var maxQ2 = $("#maxQuestnToShow2").val();
                            var maxQ3 = $("#maxQuestnToShow3").val();
                            var maxQ4 = $("#maxQuestnToShow4").val();
                            var total = parseInt(maxQ1) + parseInt(maxQ2) + parseInt(maxQ3) + parseInt(maxQ4);
											...
											if (dateinput == '') {
												...
												e.preventDefault();
											}else if (randQReq == 'Y' && selected == 'Mix') {
                                                if ((maxQ1 == 0 && maxQ2 == 0 && maxQ3 == 0 && maxQ4 == 0)) {
				...
				<script>
                    $(function() {
                        var isRandom = $('input[name=randomQuestion]:checked').val();
                        var isSame = $('#smqChk').val();

                        var selected = $('#testType').val();
                        $('#randQReq').on('click', function() {
                            isRandom = $('input[name=randomQuestion]:checked').val();
                            //alert(isSame)
                            isSame = $('input[name=randomQuestion]:checked').val();
					...
					$(function() {
						...
						$('#testType')
								.on(
										...
										function() {
											//For Mix Test
											$(".testTypeCheckBox input[type='checkbox']").val("N").prop("checked", false);
											$(".testTypeCheckBox .form-check").addClass("d-none");
											$(".testTypeCheckBox .form-check input").val(0);
																...
																$
																		.ajax({
																			...
																			success : function(
																				...
																				$('#peerFacultiesForDemo').append(optionsAsString);	
