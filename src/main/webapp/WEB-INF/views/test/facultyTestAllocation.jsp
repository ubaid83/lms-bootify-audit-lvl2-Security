          ...
          <!-- page content: START -->
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> Search Tests To Re-Allocate</li>
                            </ol>
                        </nav>
						...
						<div class="card-body">
							<div class="col-xs-12 col-sm-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_title">
                                        <h5> Search Tests To Re-Allocate</h5>
                                    ...
                                    <div class="x_content">
                                       <form:form action="searchFacultyTestAllocation"  method="post"
				modelAttribute="testObj" >
				...
				<fieldset>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 column">
						<div class="form-group">
							<form:label path="id" for="id">Tests</form:label>
							<form:select id="assid" path="id" class="form-control">
								...
								<c:forEach var="preAssigment" items="${preAssigments}" varStatus="status">
									<form:option value="${preAssigment.id}">${preAssigment.testName}</form:option>
								</c:forEach>
										...
										function() {
											...
											if (courseid) {
												$
														.ajax({
															type : 'GET',
															url : '${pageContext.request.contextPath}/getTestsByCourse?'
																	+ 'courseId='
																	+ courseid,
															success : function(
																	data) {
