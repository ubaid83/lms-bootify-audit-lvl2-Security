          ...
          <!-- page content: START -->
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">View Test Result</li>
                            </ol>
                        </nav>
										...
										<section class="panel">
											...
											<div class="panel-body progress-panel">
												<div class="row">
													...
													<div class="col-sm-12 task-progress pull-left">
														<h1>
															<img
																src="https://d30y9cdsu7xlg0.cloudfront.net/png/51139-200.png"
																width=20 height=20> TEST SCORE
														</h1>
											...
											<ul>
												<li><h2>FINAL TEST SCORE :-
														${postResultTestRecord.score}</h2></li>
