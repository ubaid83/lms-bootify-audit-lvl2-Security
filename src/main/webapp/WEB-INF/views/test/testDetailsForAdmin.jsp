                                ...
                                'T', ' ')}"></c:out>
											...
											<div class="row">
												...
												<div class="col-md-4 col-sm-6 col-xs-12 column">
													<div class="form-group">
														<sec:authorize access="hasRole('ROLE_ADMIN')">
															<c:url value="addTestFormByAdmin" var="editTestUrl">
																<c:param name="id">${test.id}</c:param>
																<c:param name="moduleId">${test.moduleId}</c:param>
															</c:url>
												...
												<div class="col-md-4 col-sm-6 col-xs-12 column">
													<div class="form-group">
														<button id="allocateTest" class="btn btn-large btn-primary mt-2"
																onclick="return clicked();" formaction="saveStudentTestForAdmin">Allocate
																Test</button>
														<button id="removeStudent"
															...
															formnovalidate="formnovalidate">De-Allocate Test</button>
														<button id="cancel" class="btn btn-danger mt-2"
															formaction="homepage" formnovalidate="formnovalidate">Cancel</button>
