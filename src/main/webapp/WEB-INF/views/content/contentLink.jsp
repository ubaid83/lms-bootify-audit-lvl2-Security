          ...
          <!-- page content: START -->
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Share Link with Students </li>
                            </ol>
                        </nav>
													...
													<div class="col-sm-8 column">
														...
														<div class="form-group">
															...
															<button id="submit" class="btn btn-xs btn-primary"
																formaction="${editurl}">Edit Link</button>
						...
						<!-- Results Panel -->
								...
								<div class="x_panel">
									<div class="x_title">
										<h5>Select Students to Share Link with | Link Shared With
											: ${noOfStudentAllocated} Students</h5>
										
									</div>
									<div class="x_content">
										<form:form action="saveStudentContentAllocation"
											id="saveStudentContentAllocation" method="post"
											...
											<fieldset>
												...
												<div class="col-sm-4 column">
													<div class="form-group">
														...
														<button id="submit" class="btn btn-xs btn-primary"
															formaction="saveStudentContentAllocation">Share
															Link with Selected Students</button>
														<button id="cancel" class="btn btn-xs"
															formaction="homepage" formnovalidate="formnovalidate">Cancel</button>
													</div>
												</div>
