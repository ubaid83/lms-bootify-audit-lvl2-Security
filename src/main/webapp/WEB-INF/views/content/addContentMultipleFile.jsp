			...
			<div class="row">
				...
				<div
					...
					<div class="card bg-white border">
						<div class="card-body">
							<h5 class="pb-2 border-bottom text-center">Add File for
										...
										<div class="col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input id="file" name="file" type="file" multiple="multiple"
													...
													Only .zip file is allowed</small> -->
											</div>
											<div id=fileSize></div>
											<ul id="output">
											</ul>
 ...
 %>
				...
				<script>
					...
					$("#acadYear").on('change', function() {
											...
											if (acadYear) { $.ajax ({
															type : 'POST',
															url : '${pageContext.request.contextPath}/findModulesByUsernameAndAcadYear?acadYear='+acadYear,
