										...
										<div class="form-group">
											...
											<c:if test="${content.moduleId ne null}">
												<button id="submit" class="btn btn-large btn-primary"
													formaction="updateLinkForModule">Update Folder</button>
											</c:if>
											<c:if test="${content.moduleId eq null}">
												<button id="submit" class="btn btn-large btn-primary"
													formaction="updateLink">Update Folder</button>
											</c:if>

											<!-- <button id="submit" class="btn btn-large btn-primary"
																formaction="updateLink">Update Link</button> -->
											<%
												} else {
											%>
											<button id="submit" class="btn btn-large btn-primary"
												formaction="addLink">Add Link</button>
											<%
												}
											%>
