					...
					<div class="card bg-white border">
						...
						<%
							...
							<h5 class="text-center pb-2 border-bottom">
								Add Folder
								 ${courseIdNameMap[content.courseId] }
							</h5>
							...
							%>
							<%-- <h5 class="text-center pb-2 border-bottom">Add/Edit Folder
								for ${courseIdNameMap[content.courseId] }</h5> --%>
										...
										<div class="col-12 text-center mt-4">
											<div class="form-group">
												...
												<c:if test="${content.moduleId eq null}">
													<button id="submit" class="btn btn-large btn-primary"
														formaction="updateFolder">Update Folder</button>
												</c:if>
												<%
													} else {
												%>
												<button id="submit" class="btn btn-large btn-primary"
													formaction="addFolder">Create Folder</button>
												<%
													}
												%>
