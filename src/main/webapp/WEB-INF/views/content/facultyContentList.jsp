...
<form:form>
				<fieldset style="min-width: 50%;">
					...
					<c:url value="/getContentUnderAPathForFaculty" var="rootFolder">
						<%-- <c:param name="courseId" value="${content.courseId}" />
						<c:param name="acadMonth" value="${content.acadMonth}" />
						<c:param name="acadYear" value="${content.acadYear}" /> --%>
					</c:url>
						...
						<div class="card-body">
							<div class="col-xs-12 col-sm-12">
								<div class="x_panel">
									...
									<div class="x_content">
										<form:form action="getContentUnderAPathForFaculty"
										...
										<div class="row">
											...
											<div class="col-12">
												<%-- <a id="submit" class="btn btn-dark mb-3"
													...
													<a
													id="submit" class="btn btn-secondary mb-3" href="${addFolder}"
													onclick="return myFunction()"><i class="fa fa-folder-o"></i>
													Add New Folder</a> <a id="submit" class="btn btn-secondary mb-3"
													...
													Add Multiple Files</a> <a id="submit" class="btn btn-secondary mb-3"
													href="${addLink}"><i class="fa fa-link""true"></i> Add
													New Link</a> <a class="btn btn-large btn-secondary mb-3"
												...
												<tbody>
													...
													<c:forEach var="content" items="${allContent}"
														...
														<tr data-tt-id="${content.id}"
															...
															<td><c:if test="${content.contentType == 'Folder' }">
																	...
																	<div class="btn-group">
																		...
																		<ul class="dropdown-menu" role="menu">
																			...
																			<li><a href="${addMultipleFile}">Add Multiple Files</a></li>
															...
															</a> <c:if test="${content.contentType eq 'Folder' }">
