			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Update
						Internal Continuous Assessment / Evaluation COMPONENT(COURSERA)</li>
					<%
						} else {
					%>
			...
			<div class="card bg-white border">
				<div class="card-body">
					<h5 class="text-center pb-2 border-bottom">
						...
						%>
						Edit Internal Continuous Assessment / Evaluation
						COMPONENT(COURSERA)
						<%
							} else {
						%>
						Add Internal Continuous Assessment / Evaluation
						COMPONENT(COURSERA)
						<%
							}
						%>
					...
					<form:form action="addIcaCoursera" method="post"
						modelAttribute="icaBean">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								<div class="form-group">
									<form:label path="acadSession" for="groupId">Select AcadSession <span
										style="color: red">*</span></form:label>
							 		<form:select multiple="multiple" id="acadSession"
										path="acadSession" required="required" class="form-control"
										style="overflow: auto;" disabled="disabled">
										
									<c:forEach var="p" items="${acadSessionList}">
							...
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								<div class="form-group">
									...
									<label path="" for="acadSession">Select Acad Session <span
			...
			$(".subjectParam")
					.on(
							...
							function() {
								...
								console.log('acad session'+acadSession);
								if (acadYear && !courseid) {
									console.log('acadYear'+acadYear);
									$
											.ajax({
												type : 'GET',
												url : '${pageContext.request.contextPath}/getModuleByParamCE?'
														+ 'acadYear='
														+ acadYear
														+ '&campusId='
														+ campusId,
								...
								if(acadYear && courseid){
									...
									//populate acad session
									
									$
												.ajax(
														{
															url : "${pageContext.request.contextPath}/getSessionByParamCE?acadYear="
																	+ acadYear
																	+ '&campusId='
																	+ campusId
																	+ '&moduleId='
																...
																$(
																		...
																		.append(
																				$(
																						'<option>',
																						{
																							value : sessionObj[i].value,
																							text : sessionObj[i].text
																						}));
									...
									.ajax( 
											{
												url : "${pageContext.request.contextPath}/GetProgramsFromAcadSessionYearModuleCE?acadYear="
														+ acadYear
														+ '&moduleId='
														+ courseid
