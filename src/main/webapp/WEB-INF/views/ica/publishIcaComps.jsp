						...
						<table class="table table-striped table-hover">
							<thead>
								<tr>
									...
									<th scope="col">Submitted Component(Not Published)</th>
									<th scope="col">Published Components</th>
							...
							<tbody>
								<c:forEach var="ica" items="${submittedIcaList}"
									...
									<tr>
										...
										<td><c:out value="${ica.submittedComps}" /></td>
										<td><c:out value="${ica.publishedComps}" /></td>
										...
										<td><c:choose>
												...
												<c:otherwise>
													<a  id="publish${ica.id}" class="showClass"
														 onclick="publishIca('${ica.id}','${ica.componentId}')">
														Publish </a>
													<p id="published${ica.id}" class="showClass"
														style="float: center; display: none;">Ica Component Published</p>
					...
					<div class="col-12 mt-3">
						<form>
							<button id="publishId" class="btn btn-large btn-primary mt-2"
								formaction="publishAllIcaComponents">Publish All</button>
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
		...
		function publishIca(icaId,compId){
            ...
            .then((willDelete) => {
              if (willDelete) {
                  ...
                  .ajax({
                        type : 'GET',
                        url : '${pageContext.request.contextPath}/publishOneIcaComponents?'
                                    + 'id=' + id+'&compId='+compId,
