						...
						<div class="card-body">
							...
							<div class="col-md-12 col-xs-12 col-sm-12">
								<div class="x_panel">
									...
									<div class="x_title">
										<h5>Grade Center For ${course.moduleName }</h5>
													...
													<div class="form-group">
														...
														<select id="courseId"
															...
															<c:forEach var="course" items="${listOfCoursesAssigned}"
																varStatus="status">
																<c:if test="${cId eq course.moduleId }">
																	<option value="${course.moduleId}" selected>${course.moduleName}</option>
																</c:if>
																<c:if test="${cId ne course.id }">
																	<option value="${course.moduleId}">${course.moduleName}</option>
																</c:if>
															</c:forEach>
														</select>
													</div>
					...
					$("#courseId")
							.on(
									...
									function() {
										...
										window.location.href = '${pageContext.request.contextPath}/gradeCenterAdmin?courseId='
