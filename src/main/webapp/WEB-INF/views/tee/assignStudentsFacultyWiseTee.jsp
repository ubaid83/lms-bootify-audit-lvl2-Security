		...
		<div class="col-lg-12 col-md-12 col-sm-12 dashboardBody p-5">
			...
			<div class="card bg-white border">
				<div class="card-body">
					...
					<div class="col-12 mt-3">
						<strong>TEE Name:</strong> <span>${tee.teeName}</span>
					</div>
					<div class="col-12 mt-3">
					...
					<div class="col-12 mt-3">
						<strong>Year:</strong> <span>${tee.acadYear}</span>
					</div>
					<div class="col-12 mt-3">
						<strong>Acad Session:</strong> <span>${tee.acadSession}</span>
					</div>
					<div class="col-12 mt-3">
						<strong>External Marks:</strong> <span>${tee.externalMarks}</span>
					</div>
					<div class="col-12 mt-3">
			...
			<div class="card bg-white border">
				<div class="card-body">
						...
						<input name="id" type="hidden" id="idTee" value="${tee.id}" />
    ...
    <div class="container-fluid">
        <div class="container">
    		...
    		<div class="col-12 mt-4">
							<button id="saveStudentsBatchWiseForTee"
								class="btn btn-large btn-primary mt-2" onclick="submitStudents1()">Add Students Faculty Wise</button>
						</div>
					<%-- </form:form> --%>
                ...
                if($("#studentList tbody tr").length == 0){
                   ...
                   $
                    .ajax({
                        type : 'POST',
                        dataType: 'JSON',
                        url : '${pageContext.request.contextPath}/saveStudentsBatchWiseForTee',
                        data: {
                            json: json
                      },
                        success : function(data) {
                            if(data.status == 'success'){
                                ...
                                window.location = '${pageContext.request.contextPath}/searchTeeList';
                                return false;
                            }else if(data.status == 'blank'){
                                alert('Select the Students');
                            }else if(data.ststus == 'failed'){
