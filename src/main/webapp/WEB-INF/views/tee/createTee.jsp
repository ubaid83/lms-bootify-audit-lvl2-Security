...
<div class="d-flex" id="facultyAssignmentPage">
	...
	<div class="container-fluid m-0 p-0 dashboardWraper">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<%
						if (isEdit) {
					%>
					<li class="breadcrumb-item active" aria-current="page">Update Term End Exam Evaluation</li>
					<%
						} else {
					%>
					<li class="breadcrumb-item active" aria-current="page">Add Term End Exam Evaluation</li>
					<%
						}
					%>
				</ol>
			...
			<div class="card bg-white border">
				<div class="card-body">
					<h5 class="text-center pb-2 border-bottom">
						...
						%>
						Edit Term End Exam Evaluation
						<%
							} else {
						%>
						Add Term End Exam Evaluation
						<%
							}
						%>
					</h5>

					<form:form action="addTee" method="post" modelAttribute="teeBean">
						...
						<div class="row">
							...
							%>
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								<form:label path="assignedFaculty" for="assignedFaculty">Assign Faculty<span style="color: red">*</span>
								</form:label>
								<c:if test="${isGradingStart eq 't'}">
                                    ...
                                    <c:if test="${multipleFaculty eq 'false'}">
                                        <form:select id="assignedFaculty" path="assignedFaculty"
                                            class="form-control">
                                            <c:forEach var="uc" items="${facultyList}">
                                                <c:if test="${teeBean.assignedFaculty eq uc.username}">
                                                    <option value="${uc.username}" selected>${uc.facultyName}-(${uc.username})</option>
                                                </c:if>
                                                <c:if test="${teeBean.assignedFaculty ne uc.username}">
                                                    <option value="${uc.username}">${uc.facultyName}-(${uc.username})</option>
                                                </c:if>
                                            </c:forEach>
                                        </form:select>
							...
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								<form:label path="assignedFaculty" for="assignedFaculty">Assign Faculty</form:label><span style="color: red">*</span>
								<c:if test="${multipleFaculty eq 'true'}">
									<form:select multiple="multiple" id="assignedFaculty"
										path="assignedFaculty" required="required"
										class="form-control" style="overflow: auto;">
						...
						<div class="row">
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								...
								<div class="form-group">
									<form:label path="externalMarks" for="externalMarks">External Marks <span style="color: red">*</span>
									</form:label>
									<c:choose>
										<c:when test="${isGradingStart eq 't'}">
							...
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								<div class="form-group">
									<form:label path="internalPassMarks" for="internalPassMarks">External Passing Marks <span style="color: red">*</span>
									</form:label>
									<c:choose>
										<c:when test="${isGradingStart eq 't'}">
						...
						<div class="row">
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								...
								<div class="input-group">
									<form:input id="startDateTee" path="startDate" type="text"
							...
							<div class="col-md-4 col-sm-6 col-xs-12 column">
								...
								<div class="input-group">
									<form:input id="endDateTeee" path="endDate" type="text"
		...
		$('.weightClass').change(function(){
			...
			var internalPassMarks=$('#internalPassMarks').val();
			var externalMarks=$('#externalMarks').val();
			var externalPassMarks=$('#externalPassMarks').val();
			var totalMarks=$('#totalMarks').val();
			console.log('internal Pass Marks'+internalPassMarks+'internal Marks'+internalMarks);
				...
				if(parseInt(internalPassMarks)>parseInt(internalMarks)){
				...
				else if(externalMarks!='' && externalMarks!=null && externalPassMarks!='' && externalPassMarks!=''){
					...
					return;
					}else if(totalMarks!='' && totalMarks!=null){
