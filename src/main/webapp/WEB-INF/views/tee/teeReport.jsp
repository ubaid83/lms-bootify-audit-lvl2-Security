	...
	<div class="container-fluid m-0 p-0 dashboardWraper">
			...
			<div class="card bg-white">
				<div class="card-body">
					...
					<div class="col-12 text-center">
						<h5 class="border-bottom pb-2 text-uppercase">Student Term End Exam
					...
					<div class="row">
							...
							<div class="form-group">
								<label for="acadYear">Report Type</label> <select
									...
									<option value="" selected disabled hidden>Select
										...
										<option value="subjWise">Subject-Wise</option>
						...
						<div class="col-12 mt-3">
							<a class="btn btn-large btn-primary"
								onclick="generateTeeReport()"> Generate Report</a>
						</div>
					</div>
		...
		<script>
			...
			if (acadYear && !acadSession) {
				...
				$
						.ajax({
							type : 'GET',
							url : '${pageContext.request.contextPath}/getSessionByParamForTeeReport?'
									+ 'acadYear='
									+ acadYear
									+ '&campusId='
									+ campusId,
		...
		console.log('acadYear'+acadYear+'acadSession'+acadSession+'programId'+programId);
			if (acadYear != null && acadSession != null
				...
				if(campusId!=null){
					window.location.href = '${pageContext.request.contextPath}/downloadTeeReport?'
						+ 'acadYear='
						+ acadYear
						+ '&acadSession='
