				...
				<div class="dashboard_container">
					...
					<div class="dashboard_container_spacing">
						...
						<div class="breadcrumb">
							...
							<i class="fa fa-angle-right"></i> Create Article
						</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="x_panel">
									...
									<div class="x_content">
										<form:form action="createArticle"
											id="createArticle" method="post"
											...
											<div class="row">
												<div class="col-md-4 col-sm-6 col-xs-12 column">
													<div class="slider round">
														<form:label path="showArticle" for="showArticle">Show Article to<span style="color: red">*</span> : </form:label>
														<br>
