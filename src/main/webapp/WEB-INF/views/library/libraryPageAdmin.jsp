        ...
        <jsp:include page="../common/newAdminTopHeader.jsp" />
                ...
                <!-- SEMESTER CONTENT -->    
						...
						<div class="card bg-white border">
							...
							<section class="searchAssign pl-3 pr-3">
                                <ul class="row nav nav-tabs text-center" id="myTab" role="tablist">
                                    <li class="nav-item col-lg-4 col-md-4 col-sm-12 mt-3">
                                        <a class="nav-link active" id="libDoc" data-toggle="tab" href="#libDocContent" role="tab">
                                    ...
                                    <li class="nav-item col-lg-4 col-md-4 col-sm-12 mt-3">
                                        <a class="nav-link" id="libRes" data-toggle="tab" href="#libResContent" role="tab">
                                            <div class="border hoverDiv">
                                                <div class="row asset1">
                                                    <div class="col-12 pb-2">
                                    ...
                                    <li class="nav-item col-lg-4 col-md-4 col-sm-12 mt-3">
                                        <a class="nav-link" id="libAnnounce" data-toggle="tab" href="#libAnnounceContent" role="tab">
                                            <div class="border hoverDiv">
                                                <div class="row asset1">
                                                    <div class="col-12 pb-2">
                                ...
                                <div class="tab-content" id="myTabContent">
                                   ...
                                   <!--DOCUMENT-->
                                    ...
                                    <div class="tab-pane fade show active" id="libDocContent" role="tabpanel" aria-labelledby="home-tab">
					...
					No Content under this folder
                                    ...
                                    <!--RESOURCES-->
                                    <div class="tab-pane fade" id="libResContent" role="tabpanel" aria-labelledby="profile-tab">
																...
																<c:forEach var="tabs" items="${tabsList}"
																	...
																	<tr data-toggle="collapse" data-parent="#myTable"
																		...
																		<td><sec:authorize
																				...
																				<a class="text-dark" href="downloadWebpageFile?id=${tabs.id}">Download</a>
                                     ...
                                     <!--ANNOUNCEMENT-->
                                    <div class="tab-pane fade" id="libAnnounceContent" role="tabpanel">
                                        <div role="tabpanel" class="tab-pane" id="register-block">
												...
												<div class="register-block-form">
													...
													<form:form cssClass="form" role="form"
														...
														<div class="table-responsive testAssignTable mt-3">

															<table id="outboxTable"
																class="table table-striped table-hover tableAnnouncement">
																	...
																	<c:forEach var="announcement" items="${page.pageItems}"
																		...
																		<tr>
																			...
																			<td><c:url value="viewAnnouncement"
																					...
																					class="fa fa-info-circle fa-lg text-info"></i></a>&nbsp; <sec:authorize
																					access="hasAnyRole('ROLE_LIBRARIAN')">
