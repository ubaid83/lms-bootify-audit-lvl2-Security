...
<%
	...
	if (isEdit) {
		...
		updateOrCreate = "Update Folder";
		link="updateLibraryFolder";
	} else {
		label = "Add Folder";
		updateOrCreate = "Create Folder";
		link="addLibraryFolder";
	}
%>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="x_panel">
									...
									<div class="x_content">
										<form:form action="createLibraryItem" id="createLibraryItem"
												...
												<div class="row">
													...
													<div class="col-sm-4 column">
														<div class="form-group">
															<form:label path="contentName" for="contentName">Folder Name  <span style="color: red">*</span><i
													...
													<div class="col-sm-4 column">
														<div class="form-group">
															<form:label path="contentDescription"
																for="contentDescription">Folder Description</form:label>
