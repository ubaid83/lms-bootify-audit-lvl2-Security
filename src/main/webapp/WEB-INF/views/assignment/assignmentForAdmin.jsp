...
<div class="d-flex adminPage dataTableBottom" id="adminPage">
    ...
    <div class="form-group">
        ...
        <button id="cancel" class="btn btn-large btn-danger" formaction="homepage" formnovalidate="formnovalidate">Cancel</button>
                    ...
                    <div class="card-body">
					<div class="col-12">
							<h5 class="text-center border-bottom pb-2">Export Assignment</h5>
						
						<div class="x_content">
						
							<form:form action="exportAssignmentForAdmin" id="exportAssignment"
											method="post" modelAttribute="assignment">
											<fieldset>
												...
												<div class="col-md-8 col-sm-12">
													<div class="form-group">
														...
														<form:select id="assid" path="courseIdToExport"
															...
															required="required" style="height : 120px;">
												...
												<div class="col-12">
													<div class="form-group">
														...
														<button id="submit" class="btn btn-success mt-3"
															formaction="exportAssignmentForAdmin" onclick="return clicked();">Export
															Assignment with Selected courses</button>
						...
						function() {
							...
							if (programid) {
								$
										.ajax({
											type : 'GET',
											url : '${pageContext.request.contextPath}/getAllCoursesByProgramId?'
													+ 'programId='
													+ programid,
											success : function(
													data) {
