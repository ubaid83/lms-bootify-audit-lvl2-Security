...
<div class="d-flex" id="facultyDashboardPage">
									...
									<form:form action="createAssignment" id="createAssignment"
										...
										<div class="form-row">
											...
											<div class="col-12 text-center">
												<h5>Update Assignment for ${assignment.course.moduleName}</h3>
											</div>
											<%
												}else{
											%>
											<div class="col-12 text-center">
												<h5>Add Assignment</h3>
											</div>
											<%
												}
											%>
											...
											<%-- <c:if test="${allCampuses.size() > 0}">
												<div
													...
													<div class="form-group">
														<form:label class="textStrong" path="campusId"
															for="campusId">Select Campus <span
											...
											<div
												...
												<div class="form-group">
													<form:label path="moduleId" for="moduleId"
														class="textStrong">Select Module</form:label>

													<form:select id="moduleId" path="moduleId" type="text"
														placeholder="module" class="form-control">
											...
											<div
												class="col-lg-4 col-md-4 col-sm-12 mt-3 position-relative">
												<div class="form-group">
													<label for="course" class="textStrong">AcadYear <span
											...
											<div
												class="col-lg-4 col-md-4 col-sm-12 mt-3 position-relative">
												<label class="textStrong">Assignment Type <span
													class="text-danger">*</span></label>
 ...
 %>
										...
										<div class="row">
											...
											<%-- <div
												...
												<div class="slider round">
													<form:label class="textStrong" path="runPlagiarism"
														for="runPlagiarism">Run Plagiarism while <span
											...
											<div
												...
												<div class="form-group">
													<form:label class="textStrong" path="threshold"
														for="threshold">Threshold Value for Plagarism Check <span
															style="color: red">*</span>
													</form:label>
														...
														<td>
															...
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox path="allowAfterEndDate"
																	id="subAfterEndDate"
																	value="${assignment.allowAfterEndDate}" />
																<div class="state p-success p-on">
																	<label>Yes</label>
																</div>
																<div class="state p-danger p-off">
														...
														<td>
															...
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox path="submitByOneInGroup"
																	id="submitByOneInGroup"
																	value="${assignment.submitByOneInGroup}" />
																<div class="state p-success p-on">
																	<label>Yes</label>
																</div>
																<div class="state p-danger p-off">
 ...
 %>
													...
													<tr>
														...
														<td>
															...
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox
																	value="${assignment.showResultsToStudents}"
 ...
 %>
													...
													<tr>
														...
														<td>
															...
															%>
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox value="${assignment.rightGrant}"
																	id="rightGrant" path="rightGrant" />
																<div class="state p-success p-on">
																	<label>Yes</label>
																</div>
																<div class="state p-danger p-off">
 ...
 %>
												...
												<c:if test="${assignment.allocateToStudents eq 'Y'}">
													<form:input type="hidden" path="allocateToStudents" />
													</c:if>
												<c:if test="${assignment.allocateToStudents ne 'Y'}">
													<tr>
														<td>Allocate to All Students</td>
														<td>
															<%
																if(isEdit) {
															%>
															...
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox value="${assignment.allocateToStudents}"
																	id="allocateToStudents" class="custToggle"
																	path="allocateToStudents" />
 ...
 %>
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox value="N" id="allocateToStudents"
																	class="custToggle" path="allocateToStudents" />
																<div class="state p-success p-on">
																	<label>Yes</label>
																</div>
																<div class="state p-danger p-off">
 ...
 %>
													...
													<tr>
														...
														<td>
															...
															%>
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox value="${assignment.sendEmailAlert}"
 ...
 %>
													...
													<tr>
														...
														<td>
															...
															%>
															<div class="pretty p-switch p-fill p-toggle">
																<form:checkbox value="${assignment.sendSmsAlert}"
													...
													<c:if test="${sendAlertsToParents eq true}">
														<tr>
															...
															<td>
																...
																<div class="pretty p-switch p-fill p-toggle">
																	<form:checkbox
																		value="${assignment.sendEmailAlertToParents}"
 ...
 %>
														...
														<tr>
															...
															<td>
																...
																<div class="pretty p-switch p-fill p-toggle">
																	<form:checkbox
																		value="${assignment.sendSmsAlertToParents}"
																		id="sendEmailAlertParents"
										...
										<div class="col-6 m-auto">
											<div class="form-row mt-5">
												...
												<button id="submit"
													...
													formaction="updateAssignmentForModule">Update
													Assignment</button>
												<%
													} else {
												%>
												<button id="submit" onclick="myFunction()"
													class="btn btn-info col-md-5 col-sm-12  ml-auto mr-auto mb-3"
													formaction="createAssignmentForModule">Create
													Assignment</button>
												<%
													}
												%>
														...
														function() {
															...
															if (moduleId) {
																$
																		.ajax({
																			type : 'GET',
																			url : '${pageContext.request.contextPath}/getAcadYearByModuleId?'
																					+ 'moduleId='
																					+ moduleId,
																			success : function(
																					data) {
