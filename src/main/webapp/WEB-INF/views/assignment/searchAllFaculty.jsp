											...
											<div class="row">
												<div class="col-sm-4 col-md-4 col-xs-12 column">
													<div class="form-group">
														<form:label path="acadMonth" for="acadMonth">Academic Month 
														</form:label>
												...
												<div class="col-sm-4 col-md-4 col-xs-12 column">
													<div class="form-group">
														<form:label path="acadYear" for="acadYear">Academic Year
														</form:label>
												...
												<div class="col-sm-4 col-md-4 col-xs-12 column">
													<div class="form-group">
														<form:label path="" for="">Select Assignments/Test/Learning Resource</form:label>
													...
													<table class="table table-striped table-hover"
														...
														<thead>
															<tr>
																...
																<th>Description</th>
																<th>Visible From <i class="fa fa-sort"
																	aria-hidden="true" style="cursor: pointer"></i></th>
																<th>Visible Till <i class="fa fa-sort"
																	aria-hidden="true" style="cursor: pointer"></i></th>
														...
														<tbody>
															...
															<c:forEach var="content" items="${allContent}"
																...
																<tr data-tt-id="${content.id}"
																	...
																	<td><c:out value="${content.courseName}"></c:out></td>
														...
														<thead>
															<tr>
																...
																<th>Faculty ID <i class="fa fa-sort"
																	aria-hidden="true" style="cursor: pointer"></i></th>
																<th>Test Name <i class="fa fa-sort"
																	aria-hidden="true" style="cursor: pointer"></i></th>
																<th>Course Name</th>
																...
																<th>Maximum Score <i class="fa fa-sort"
																	aria-hidden="true" style="cursor: pointer"></i></th>
																<th>Duartion <i class="fa fa-sort"
																	aria-hidden="true" style="cursor: pointer"></i></th>
															...
															<c:forEach var="test" items="${testList}"
																...
																<tr>
																	...
																	<td><c:url value="viewThisTest" var="detailsUrl">
																			...
																			value="downloadTestQuestionByTestId"
																			var="downloadTestQuestionUrl">
																			<c:param name="testId" value="${test.id}" />
																		</c:url> <a href="${downloadTestQuestionUrl}" title="Details"><i
							...
							<div class="card bg-white border">
                                ...
                                'T', ' ')}"></c:out></td>
																	...
																	<sec:authorize access="hasRole('ROLE_FACULTY')">
																		<td>
																			<c:url value="viewThisAssignment" var="detailsUrl">
																				<c:param name="assignmentId"
																					value="${assignment.id}" />
																			</c:url> <c:url value="viewThisAssignmentForModule"
																				var="detailsUrlModule">
																				<c:param name="assignmentId"
																					value="${assignment.id}" />
																			</c:url> <c:if test="${assignment.courseId ne null}">
																				<a href="${detailsUrl}" title="Details"><i
																					class="fa fa-info-circle fa-lg"></i></a>
																			</c:if> <c:if test="${assignment.courseId eq null}">
																				<a href="${detailsUrlModule}" title="Details"><i
																					class="fa fa-info-circle fa-lg"></i></a>
																			</c:if>&nbsp;</td>
																	</sec:authorize>
																</tr>
