                      ...
                      <nav aria-label="breadcrumb">
						...
						<div class="card bg-white border">
							<div class="card-body">
									...
									<div class="x_content">
										<form:form action="evaluateByStudentForModule" method="post"
											modelAttribute="assignment">
											<fieldset>
                                               <div class="form-row">
												<div class="col-lg-6 col-md-6 col-sm-6 mt-3">
													<div class="form-group">
														<form:label path="moduleId" for="moduleId">Module</form:label>
									...
									<div class="card-body">
											<div class="text-center">
												...
												<a href="gradeCenterForm"><i
													...
													<a
													href="downloadAllFileForModule?assignmentId=${assignment.id}"><i
													...
													<a
														...
														href="checkCopiedAssignmentForModule?assignmentId=${assignment.id}"><i
												...
												<c:if test="${false}"> 
												<a
													href="checkForPlagiarismAllForModule?assignmentId=${assignment.id}"><i
											...
											<a href="#"><i class="btn btn-large btn btn-dark mt-2" data-toggle="modal" 
													data-target="#uploadmarkModal">Upload Marks For Modulewise Evaluation</i></a>
													</div>
											<div class="x_content">
																	...
																	<div class="modal-dialog">
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body">
																				...
																				<%-- <c:if test="${assignment.threshold eq null}">
...
<div class="modal fade fnt-13"
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
		...
		<div class="modal-content">
			...
			<form:form action="uploadStudentAssignmentMarksExcelByModule" id="uploadStudentAssignmentMarksExcel"
			...
			<div class="modal-footer">
				...
				<button id="submitRemarkFiles" class="btn btn-modalSub" name="submitRemarkFiles" 
						formaction="uploadStudentAssignmentMarksExcelByModule?assignmentId=${assignment.id}">Submit</button>
			</div>
			</form:form>
		</div>
	</div>
													...
													function() {
														...
														if (moduleId) {
															$
																	.ajax({
																		type : 'GET',
																		url : '${pageContext.request.contextPath}/getAssigmentByModule?'
																				+ 'moduleId='
																				+ moduleId,
																		success : function(
																				data) {
