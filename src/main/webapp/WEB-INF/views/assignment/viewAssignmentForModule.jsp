...
<div class="d-flex dataTableBottom" id="facultyAssignmentPage">
		...
		<div class="container mt-5">
			<div class="row">
				...
				<div
					...
					<div class="card-body">
						<div class="x_title">
							<h5 class='text-center border-bottom pb-2'>Assignment for ${assignment.course.moduleName}</h5>
						</div>
							<form:form action="createAssignmentForm" id="editAssignment" class="font-weigth-bold"
								...
								<fieldset>
									...
									<div class="row">
										...
										<div class="col-md-6 col-sm-6 col-xs-12 column">
											<div class="form-group">
												<form:label path="facultyId" for="facultyId"><strong>Allocated To All Students:</strong></form:label>
												${assignment.allocateToStudents}
											</div>
										</div>
    ...
    <div class="form-group">
        <sec:authorize access="hasRole('ROLE_FACULTY')">
            <button id="submit" class="btn btn-large btn-secondary" formaction="createAssignmentFromMenuForModule?id=${assignment.id}">Edit
                Assignment</button>
        </sec:authorize>
        <%-- <sec:authorize access="hasRole('ROLE_FACULTY')">
        ...
        <button id="cancel" class="btn btn-large btn-danger" formaction="homepage" formnovalidate="formnovalidate">Cancel</button>
					...
					<c:if test="${$allocateToStudents eq 'Y'}"></c:if>
					...
					<div class="col-12">
						...
						<div class="x_content">
							...
							<form:form action="saveStudentAssignmentAllocationForModule"
								id="saveStudentAssignmentAllocationForModule" method="post"
										...
										<thead>
											<tr>
												...
												<th><input name="select_all" value="1"
													...
													<!-- <th>DeAllocate Student <i class="fa fa-sort"
									...
									<div class="form-group">
										<sec:authorize access="hasRole('ROLE_FACULTY')">
											<button id="submit" class="btn btn-large btn-primary"
												...
												formaction="saveStudentAssignmentAllocationForModule">Allocate
												Assignment</button>
										</sec:authorize>
				...
				.on(
						...
						function() {
							...
							var id = ${id};
							window.location = '${pageContext.request.contextPath}/viewAssignmentForModule?id='
