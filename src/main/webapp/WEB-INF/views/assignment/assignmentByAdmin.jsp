...
<div class="d-flex adminPage" id="adminPage">
	...
	<div class="container-fluid m-0 p-0 dashboardWraper">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 dashboardBody p-5">
			...
			<!-- <div class="col-lg-12 col-md-12 col-sm-12 dashboardBody ml-auto mr-auto"> -->
    ...
    <div class="form-group">
        <sec:authorize access="hasRole('ROLE_ADMIN')">
            ...
            <button id="submit" class="btn btn-large btn-secondary" formaction="createAssignmentByAdmin?id=${assignment.id}">Edit
                Assignment</button>
        </sec:authorize>
        <sec:authorize access="hasRole('ROLE_ADMIN')">
       	<c:if test="${assignment.isQuesConfigFromPool eq 'Y'}">
       	<c:if test="${assignment.randomQuestion eq 'Y'}">
        	<button id="submit" class="btn btn-large btn-secondary" formaction="addAssignmentQuestionPoolConfigurationForm?assignmentId=${assignment.id}">Question Pool Configuration</button>
        </c:if>
			<button id="submit" class="btn btn-large btn-secondary" formaction="viewAssignmentQuestionsByTestPoolForm?assignmentId=${assignment.id}">Configure assignment question</button>
		</c:if>
        <c:if test="${showStudentsToAlloc eq 'true'}">
													...
													<td><sec:authorize access="hasRole('ROLE_ADMIN')">
															<c:if test="${empty student.id }">
																<form:checkbox path="students"
																	value="${student.username}" class="studentIds"/>
															</c:if>
