				...
				<div
					...
					<div class="bg-white pb-5">
						...
						<div class="form-row">
							...
							<div class="col-lg-5 col-md-5 col-sm-12 mt-3 ml-3">
								<label class="sr-only">Select Course</label> <select
									class="form-control" id="reportCourseParent">
					...
					<section class="assignWrap">
                                ...
                                <canvas id="assignReportChartParent"></canvas>
                                </section>
                     ...
                     <section class="mt-5 testWrap">
                                ...
                                <section class="col-12 mb-5 fnt-13 chartWrap">
                                <canvas id="testReportChartParent"></canvas>
                                </section>
