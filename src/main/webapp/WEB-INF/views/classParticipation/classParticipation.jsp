			...
			<div class="row">
				...
				<div
					...
					<div class="card bg-white border">
						<div class="card-body">
							<div class="x_title">
								<h5 class="text-center border-bottom pb-2">Class
									Participation for ${courseName }</h5>
							...
							<div class="x_content">
								...
								<button class="btn btn-md btn-info" data-toggle="modal"
									data-target="#uploadStudentsMarks">Upload Students
									Marks</button>
							</div>
						</div>
					</div>
					...
					<div class="modal fade" id="uploadStudentsMarks" tabindex="-1"
						...
						<div
							...
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="uploadStudentsMarksTitle">Upload
										Students Marks</h5>
								...
								<div class="modal-body">
									...
									<form:form id="uploadStudentsMarks"
										action="uploadStudentsMarks"
										modelAttribute="classParticipation"
											...
											<div class="col-sm-12 column">
												...
												<div class="row">
													<div class="col-md-8">
														...
														<label class="textStrong">Class participation
															template : </label> <a
															href="${pageContext.request.contextPath}/downloadStudents?courseId=${courseId}"
															class="btn btn-link"><i>Download Class
																participation template </i></a>

														<form:hidden path="courseId" value="${courseId}" />
														<button type="Submit" formaction="uploadStudentsMarks"
				...
				<script>
					...
					$("#classParticipationTable").on("click", ".likeClass", function(){
						console.log("likeClass called");
										...
										//alert(remarks);
										console
												.log('${pageContext.request.contextPath}/saveClassParticipation?'
														+ 'studentUsername='
														+ username
														+ '&score='
														+ score
