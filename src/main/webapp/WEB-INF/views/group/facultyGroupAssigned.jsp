						...
						<div class="card-body">
							<div class="col-xs-12 col-sm-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form:form action="saveFacultyGroupAllocation" method="post" modelAttribute="groups">
				<fieldset>
					...
					<form:input path="id" type="hidden" />
						...
						<table class="table table-striped table-hover" style="font-size:12px">
							...
							<c:forEach var="groups" items="${list1}" varStatus="status">
						        <tr>
						            <td><c:out value="${status.count}" /></td>
									<td><c:out value="${groups.groupName}"/>  </td>
									<td><c:out value=""/> ${groups.createdBy} </td>
									<td>
					...
					<div class="col-sm-4 column">
						<div class="form-group">
							<button id="cancel" class="btn btn-large btn-danger"
								formaction="saveFacultyGroupAllocation" formnovalidate="formnovalidate">Save</button>
