										...
										<div class="table-responsive">
											<table class="table  table-hover">
												<thead>
													<tr>
														<th>Sr. No.</th>
														<th>Username <i class="fa fa-sort" aria-hidden="true"
												...
												<div class="col-sm-8 column">
													 ...
													 <div class="form-group">
														<!-- <button id="cancel" class="btn btn-danger" type="button"
															...
															<button type="button" class="btn btn-danger"><a href="${pageContext.request.contextPath}/homepage">Cancel</a></button>
