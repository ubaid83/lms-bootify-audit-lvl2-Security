				...
				<div class="dashboard_container">
					...
					<div class="dashboard_container_spacing">
						...
						<div class="breadcrumb">
							...
							<i class="fa fa-angle-right"></i> Add Admin Menu Rights
						</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="x_panel">
									...
									<div class="x_content">
										<form:form action="addAdminMenuRights" method="post"
											modelAttribute="user">
											...
											<div class="row">
												...
												<div class="col-sm-4 column">
													...
													<div class="form-group">
														<form:label path="schoolAbbr" for="schoolAbbr">School Abbr <span style="color: red">*</span></form:label>
												...
												<div class="col-sm-12 column">
													<div class="form-group">
														...
														<button id="submit" class="btn btn-large btn-primary"
															formaction="addAdminMenuRights">Add</button>
