				...
				<div class="dashboard_container">
					...
					<div class="dashboard_container_spacing">
						...
						<div class="breadcrumb">
							...
							<i class="fa fa-angle-right"></i> Add New Admin School wise
						</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12">
								<div class="x_panel">
									...
									<div class="x_title">
										<h2>Add New Admin School wise</h2>
									...
									<div class="x_content">
										<form:form action="addNewAdminSchoolWise" method="post"
											modelAttribute="user">
												...
												<div class="col-sm-12 column">
													<div class="form-group">
														...
														<button id="submit" class="btn btn-large btn-primary"
															formaction="addNewAdminSchoolWise">Add</button>
