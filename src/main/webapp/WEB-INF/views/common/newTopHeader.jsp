			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					<sec:authorize access="hasRole('ROLE_STUDENT')">
						...
						<c:if
							test="${loggeedInApp eq 'MBC' || loggeedInApp eq 'AAVP-UNAIDED' || loggeedInApp eq 'AAVP-AIDED' || loggeedInApp eq 'NMC'}">

							<%-- <c:choose>
								<c:when test="${downloadAvailable eq 'yes'}">
									<li class="nav-item"><a class="nav-link" target="_blank"
										href="downloadExamResult"> Exam Result <i
							...
							<c:choose>
								<c:when test="${downloadAvailable eq 'yes'}">
									<li class="nav-item"><a class="nav-link" target="_blank"
										href="${pageContext.request.contextPath}/downloadExamResult"> Evaluation Report <i
											class="fas fa-download"></i></a></li>
								</c:when>
							</c:choose>
						...
						<%-- <c:if
							test="${loggeedInApp eq 'KPMSoL'">

									<li class="nav-item"><a class="nav-link" target="_blank"
										href="viewSelectiveEvents"> Electives/Specializations Registration <i
											class="fas fa-download"></i></a></li>
...
%>
						...
						<c:if test="${tcsLink eq true}">
							<li id="navTcs" class="nav-item"><a class="nav-link" target="_blank"
								href="https://g21.tcsion.com/LX/INDEXES/AppLaunchSAML?app_id=9517&org_id=${orgId}&serviceid=20&lsamltype=${appName}"><i
									class="fas 
						fa-desktop blink"></i> Examinations</a></li>
						</c:if>
						...
						<li id="navIca" class="nav-item dropdown" data-toggle="tooltip"
							...
							<div id="navDropdownSupport"
							 ...
							 <a class="dropdown-item" href="<c:url value="showNCMarks" />">Non
									Credit Marks</a>
                        ...
                        <li id="navTEE" class="nav-item dropdown" data-toggle="tooltip" data-placement="bottom" title="TEE">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fab fa-readme"></i>TEE</a>
                            <div id="navDropdownSupport" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<c:url value=" showExternalMarks" />">TEE Marks</a>
                            </div>
                        </li>
                        <%-- </c:if> --%>
                        <!--   TEE Ends  -->
                        <!-- LOR START -->
                       <c:if test="${(appNameForTee eq 'MPSTME-NM-M') || (appNameForTee eq 'CIPS')}">
                        <li id="navMessage" class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="#" role="button"
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="fas fa-book-reader"></i> International Relations Office
						</a>
							<div id="navDropdownMessage"
								class="dropdown-menu dropdown-menu-right"
								aria-labelledby="navbarDropdown">
								<a class="dropdown-item"
									href="${pageContext.request.contextPath}/lorApplicationForm">Apply for LOR
									</a>
									<a class="dropdown-item"
									href="${pageContext.request.contextPath}/viewLorApplication">View LOR
									</a>
							</div>
							</li>
							</c:if>
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="#"><i
								class="fas fa-id-badge"></i> ${appNameForTee} ID: ${userBean.username}</a>
								<a class="dropdown-item" href="#"><i class="fas fa-id-card-alt"></i> RollNo.: ${userBean.rollNo}</a>
								 <a
