								...
								<div class="x_panel">
									...
									<div class="x_title">
										...
										<c:if test="${showDropDown ne 'true'}">
											...
											<h5>Create Forum for ${forum.course.courseName }</h5>
										</c:if>
											...
											<div class="row">
												<div class="col-sm-6 col-md-4 col-xs-12 column">
													<div class="form-group">
														<form:label path="courseId" for="courseId">Course <span
						...
						<textarea class="form-group" path="question" required="required"
							id="editor" style="margin-top: 30px;margin-bottom:10px" />
											...
											<div class="row">
												<div class="col-sm-6 col-md-4 col-xs-12 column">
													<div class="form-group">
														<form:label path="topic" for="topic">Topic <span
																style="color: red">*</span>
														</form:label>
												...
												<div class="col-sm-12 column">
													<div class="form-group">
														<button id="submit" class="btn btn-large btn-primary"
															formaction="createForum">Create Forum</button>
